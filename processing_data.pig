...
lines = LOAD '/labb5/2018_jan.txt' USING PigStorage(' ') AS (logdate: chararray, time: chararray, category: chararray, method: chararray, url: chararray);
...
STORE greater_80_visitors INTO '/labb5/results' USING PigStorage(',');